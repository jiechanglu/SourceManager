    ...
    <div class="tmpl">
            ...
            <div class="operation">
                <el-row>
                    <el-col :span="9">
                        <!-- 下面是gooslist补充的内容 -->
                        <!-- <span class="wrapper"> -->
                        <el-button type="info"><i class="el-icon-plus icon"></i>
                            <router-link to="/admin/goodsadd">新增</router-link>
                        </el-button>
        ...
        <el-row>
            <div class="table" style="padding:10px;">
                <el-row>
                    <el-col :span="24">
                        <el-table id="all" ref="multipleTable" :data="list" border tooltip-effect="dark" @selection-change="getrows" style="width: 100%;height:400px;overflow-y:scroll;">
        ...
        methods: {
            ...
            delRow() {
                ...
                if (this.ids.length <= 0) {
                    this.$message.error('请勾选你要删除的数据再执行删除命令');
                    return;
                }
                this.$confirm('你确认要删除数据吗？', '删除提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    // 注意下面请求删除数据时路径不能添加/del/:(这个冒号)+this.ids
